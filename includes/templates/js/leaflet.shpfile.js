...
L.Shapefile = L.GeoJSON.extend({
  options: {
    importUrl: null//'static/js/shp.js'
  },
  ...
  initialize: function(file, options) {
    ...
    if (typeof cw !== 'undefined') {
      ...
      if (!options.isArrayBuffer) {
        this.worker = cw(new Function('data', 'cb', 'importScripts("static/js/shp.js");shp(data).then(cb);'));
      } else {
        this.worker = cw(new Function('data', 'importScripts("static/js/shp.js"); return shp.parseZip(data);'));
      }
